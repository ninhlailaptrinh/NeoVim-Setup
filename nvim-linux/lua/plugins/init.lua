return require('packer').startup(function(use)
  ...
  -- Tmux integration
  use {
    'christoomey/vim-tmux-navigator',     -- Di chuyển mượt mà giữa tmux panes và vim splits
    'preservim/vimux',                    -- Tương tác với tmux từ vim
    'tmux-plugins/vim-tmux',              -- Syntax highlighting cho tmux.conf
    'tmux-plugins/vim-tmux-focus-events', -- Hỗ trợ focus events trong tmux
  }
